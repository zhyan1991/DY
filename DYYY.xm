...
- (void)addCloseButtonToViewController:(UIViewController *)viewController {
    ...
    [NSLayoutConstraint activateConstraints:@[
        [closeButton.trailingAnchor constraintEqualToAnchor:viewController.view.trailingAnchor constant:-10],
        [closeButton.topAnchor constraintEqualToAnchor:viewController.view.topAnchor constant:40],
        [closeButton.widthAnchor constraintEqualToConstant:80],
        [closeButton.heightAnchor constraintEqualToConstant:40]
    ]];
}

- (void)addHandleBarToViewController:(UIViewController *)viewController {
    ...
    [viewController.view addSubview:handleBar];

    [NSLayoutConstraint activateConstraints:@[
        [handleBar.centerXAnchor constraintEqualToAnchor:viewController.view.centerXAnchor],
        [handleBar.topAnchor constraintEqualToAnchor:viewController.view.topAnchor constant:8],
